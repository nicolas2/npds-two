...
function adm_translate($phrase) {
 ...
 switch($phrase) {
  ...
  case "Type :": $tmp="类型:"; break;
  case "- Mot de Passe (si Privé) - Le nom du fichier de formulaire (si Texte étendu) => lib/sform/forum - Les Groupes ID (si Groupe)": $tmp="密码 (如果是私人的) 表格的文件名 => lib/sform/forum - 组的ID (如果是已经存在的组)"; break;
  ...
  case "Ce fichier est appelé dans l'évèment ONLOAD de la balise BODY => JAVASCRIPT": $tmp="本文件将在BODY => JAVASCRIPT中的ONLOAD事件中被调用"; break;
