...
class hack {
    ...
    public static function remove($Xstring) 
    {
        if ($Xstring != '') 
        {
            ...
            // 2 dernières séquences = NCR (dec|hexa) correspondant aux caractères latin 
            // du bloc unicode Halfwidth and Fullwidth Forms.
            // Leur signification est identique à celle des caractères latin de la table 
            // ascii dont le code ascii est entre 33 et 126.
            // JPB for NPDS 2005
