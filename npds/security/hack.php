...
class hack
{
    ...
    public static function MNSremove($Xstring)
    {
        ...
        $npds_forbidden_words = array(
            // NCRs 2 premières séquences = NCR (dec|hexa) correspondant aux 
            // caractères latin de la table ascii (code ascii entre 33 et 126)
            // 2 dernières séquences = NCR (dec|hexa) correspondant aux 
            // caractères latin du bloc unicode Halfwidth and Fullwidth Forms.
            // Leur signification est identique à celle des caractères latin
            //  de la table ascii dont le code ascii est entre 33 et 126.
            // JPB for NPDS 2005
            "'&#(33|x21|65281|xFF01);'i" => chr(33),
            "'&#(34|x22|65282|xFF02);'i" => chr(34),
            "'&#(35|x23|65283|xFF03);'i" => chr(35),
