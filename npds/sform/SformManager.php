...
class SformManager 
{
     ...
     * @param boolean $obligation [description]
     ...
     * @param string  $type       [description]
     * @param string  $modele     [description]
     * @param boolean $obligation [description]
     * @param string  $size       [description]
     */
     ...
     * @param  [type] $controle [description]
     * @return [type]           [description]
     */
     ...
     * @param  [type] $mess_ok      [description]
     * @param  string $presentation [description]
     * @return [type]               [description]
     */
