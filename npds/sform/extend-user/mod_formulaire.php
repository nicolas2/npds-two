...
if ($smilies) 
{
    ...
    // - si vous mettez un // devant les deux lignes B1 et raz_avatar celà 
    // équivaut à ne pas autoriser cette fonction de NPDS
    // - le champ B1 est impératif ! La taille maxi du fichier téléchargeable 
    // peut-être changée (le dernier paramètre) et est en octets (par exemple 20480 = 20 Ko)
    // - on a une incohérence la dimension de l'image est fixé dans les préférences 
    // du site et son poids ici....
