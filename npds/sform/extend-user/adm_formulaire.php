...
// quand un form est utilisé plusieurs fois dans des context différents 
// add/mod/new les variables ne sont pas toujours defini ce qui entraine 
// des notices php dans les if ...solution peu élégante mais efficace
if(!isset($chng_uname)) 
{
    $chng_uname = '';
}
