...
function topicsmanager() {
       ...
       <div class="card card-body mb-2" id="top_'.$topicid.'">
          <div class=" topi">
             ...
             <div class="">
                <h4 class="my-3"><a href="admin.php?op=topicedit&amp;topicid='.$topicid.'" ><i class="fa fa-edit mr-1 align-middle"></i>'.language::aff_langue($topicname).'</a></h4>
    ...
    ';
       ...
       ';
       echo auto::auto_complete_multi('admin', 'aid', 'authors', 'topicadmin', '');
...
function topicedit($topicid) 
{
       ...
       echo '
       <hr />
       <h3 class="mb-1">'.adm_translate("Editer le Sujet :").' <span class="text-muted">'.language::aff_langue($topicname).'</span></h3>';
...
function topicdelete($topicid, $ok=0) 
{
       ...
       echo '
       <h3 class=""><span class="text-danger">'.adm_translate("Effacer le Sujet").' : </span>'.language::aff_langue($topictext).'</h3>';
       ...
       echo'
          <p>'.adm_translate("Etes-vous sûr de vouloir effacer ce sujet ?").' : '.language::aff_langue($topictext).'</p>
