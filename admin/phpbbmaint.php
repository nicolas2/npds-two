...
{
       global $hlpfile, $NPDS_Prefix, $f_meta_nom, $f_titre, $adminimg, $gmt;
...
function ForumMaintTopicDetail($topic, $topic_title) 
{
       ...
       <p class="text-right small text-muted">[ '.date::convertdate($post_time).' ]</p>
    ...
    if ($topics) {
       foreach($topics as $topic_id => $value) {
          if ($value == 'on') {
             ...
             forumupload::control_efface_post("forum_npds", "", $topic_id, "");
          }
       }
       sql_free_result();
    }
...
function ForumMaintAdmin() 
{
       ...
       echo auto::auto_complete("forname", "forum_name", "forums", "titreforum", "86400");
