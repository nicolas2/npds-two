...
function ForumGo($cat_id) 
{
       ...
       <table data-toggle="table" data-striped="true" data-search="true" data-show-toggle="true" data-show-columns="true" data-mobile-responsive="true" data-buttons-class="outline-secondary" data-icons="icons" data-icons-prefix="fa">
          <thead>
             <tr>
                ...
                <th class="n-t-col-xs-1" data-sortable="true" data-halign="center" data-align="center"><img class="n-smil" src="assets/images/forum/subject/07.png" alt="icon_pieces jointes" title="'.adm_translate("Attachement").'" data-toggle="tooltip"></th>
       ...
       while(list($forum_id, $forum_name, $forum_access, $forum_moderator, $forum_type, $arbre, $attachement, $forum_index) = sql_fetch_row($result)) {
          $moderator = str_replace(' ', ', ', forumauth::get_moderator($forum_moderator));
       ...
       <form id="fadaddforu" action="admin.php" method="post">
          <div class="form-group row">
             ...
             <div class="col-sm-8">
                ...
                <span class="help-block text-right" id="countcar_forum_index"></span>
             </div>
          </div>
          <div class="form-group row">
       ...
       echo auto::auto_complete_multi('modera', 'uname', 'users', 'l_forum_mod', 'WHERE uid<>1');
          ...
          switch (e.target.value) {
            ...
            break;
             ...
             case "8":
                ...
                helptext.html("=> lib/sform/forum<span class=\"float-right\" id=\"countcar_forum_pass\"></span>")
...
function ForumGoEdit($forum_id, $ctg) 
{
       ...
       $moderator = str_replace(' ', ',', forumauth::get_moderator($forum_mod));
       ...
       echo auto::auto_complete_multi('modera', 'uname', 'users', 'forum_mod', 'WHERE uid<>1');
...
function ForumCatDel($cat_id, $ok=0) 
{
    ...
    if ($ok == 1) {
       ...
       while(list($forum_id) = sql_fetch_row($result)) {
           ...
           forumupload::control_efface_post("forum_npds", "", "", $forum_id);
