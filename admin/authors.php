...
function displayadmins() 
{
    ...
    <form id="nou_adm" action="admin.php" method="post">
        ...
        $arg1 = '
            ...
            '.auto::auto_complete('admin', 'aid', 'authors', '', '0').'
            '.auto::auto_complete('adminname', 'name', 'authors', '', '0').'
 ...
 * @param  [type] $chng_aid [description]
 * @return [type]           [description]
 */
 ...
 * @param  [type] $del_dr_aid [description]
 * @return [type]             [description]
 */
 ...
 * @param  [type] $chng_aid         [description]
 * @param  [type] $chng_name        [description]
 * @param  [type] $chng_email       [description]
 * @param  [type] $chng_url         [description]
 * @param  [type] $chng_radminsuper [description]
 * @param  [type] $chng_pwd         [description]
 * @param  [type] $chng_pwd2        [description]
 * @param  [type] $ad_d_27          [description]
...
function updateadmin($chng_aid, $chng_name, $chng_email, $chng_url, $chng_radminsuper, $chng_pwd, $chng_pwd2, $ad_d_27, $old_pwd) 
{
    ...
    if ($chng_pwd2 != '') 
    {
        ...
        $min_ms = 100;
        $options = ['cost' => auth::getOptimalBcryptCostParameter($chng_pwd, $AlgoCrypt, $min_ms)];
...
switch ($op) {
    ...
    case 'AddAuthor':
        ...
        $AlgoCrypt = PASSWORD_BCRYPT;
        $min_ms = 100;
        $options = ['cost' => auth::getOptimalBcryptCostParameter($add_pwd, $AlgoCrypt, $min_ms)];
