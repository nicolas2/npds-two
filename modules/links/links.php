...
function popgraphics($count) 
{
    if ($count < 1) 
    {
        echo '<span class="btn btn-danger btn-sm float-right" title="'.translate("Les nouveaux liens de cette catégorie ajoutés aujourd'hui").'" data-toggle="tooltip" data-placement="left">N</span>';
    }
    
    if ($count <= 3 && $count >= 1)
    {
        echo '<span class="btn btn-success btn-sm float-right" title="'.translate("Les nouveaux liens ajoutés dans cette catégorie dans les 3 derniers jours").'" data-toggle="tooltip" data-placement="left">N</span>';
    }
    
    if ($count <= 7 && $count > 3) 
    {
        echo '<span class="btn btn-infos btn-sm float-right" title="'.translate("Les nouveaux Liens ajoutés dans cette catégorie cette semaine").'" data-toggle="tooltip" data-placement="left">N</span>';
    }
}
