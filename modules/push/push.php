...
include("modules/push/config/push.php");

/**
 * [push_header description]
...
function push_news() 
{
    global $push_news_limit, $NPDS_Prefix;
...
{
    global $nuke_url, $follow_links, $datetime, $NPDS_Prefix;
...
{
    global $anonymous, $push_member_col, $push_member_limit, $nuke_url, $page, $NPDS_Prefix; 
...
if (($cache_obj->genereting_output == 1) or 
    ($cache_obj->genereting_output == -1) or 
    (!$SuperCache)) 
{
    settype($op, 'string');
