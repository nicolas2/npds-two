...
*/
if(file_exists('lib/grab_globals.php')) include ('lib/grab_globals.php');
...
/*
# install/etape_4.php
# Définition des paramètres de connexion à la base de données (config/config.php)
#   => install/libraries/lib-inc.php
...
/*
# install/etape_5.php
# Définition d'autres paramètres (config/config.php)
#   => install/libraries/lib-inc.php
