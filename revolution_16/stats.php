...
if (!function_exists("Mysql_Connexion"))
   ...
   <table data-toggle="table" data-mobile-responsive="true">
      ...
      <tbody>';
   if ($ibid=theme_image("stats/explorer.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/explorer.gif";
   echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/firefox.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/firefox.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/opera.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/opera.gif";
     echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/chrome.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/chrome.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/safari.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/safari.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/webtv.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/webtv.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/konqueror.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/konqueror.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/lynx.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/lynx.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/altavista.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/altavista.gif";
      echo '
         <tr>
   ...
   <table data-toggle="table" data-mobile-responsive="true" >
      ...
      <tbody>';
   if ($ibid=theme_image("stats/windows.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/windows.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/linux.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/linux.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/mac.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/mac.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/bsd.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/bsd.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/sun.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/sun.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/irix.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/irix.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/be.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/be.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/os2.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/os2.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/aix.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/aix.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/android.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/android.gif";
      echo '
         <tr>
   ...
   if ($ibid=theme_image("stats/ios.gif")) $imgtmp=$ibid; else $imgtmp="assets/images/stats/ios.gif";
      echo '
         <tr>
...
//      var_dump($Default_Theme);
   ...
   if ($ibid=theme_image("stats/postnew.png")) $imgtmp=$ibid; else $imgtmp="assets/images/admin/postnew.png";
   echo '
   ...
   if ($ibid=theme_image("stats/topicsman.png")) $imgtmp=$ibid; else $imgtmp="assets/images/admin/topicsman.png";
   echo '
   ...
   if ($ibid=theme_image("stats/sections.png")) $imgtmpS=$ibid; else $imgtmpS="assets/images/admin/sections.png";
   echo '
   ...
   if ($ibid=theme_image("stats/sections.png")) $imgtmp=$ibid; else $imgtmp="assets/images/admin/sections.png";
   echo '
   ...
   if ($ibid=theme_image("stats/submissions.png")) $imgtmp=$ibid; else $imgtmp="assets/images/admin/submissions.png";
   echo '
