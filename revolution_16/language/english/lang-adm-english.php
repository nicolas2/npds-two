...
function adm_translate($phrase) {
 ...
 switch($phrase) {
  ...
  case "Type :": $tmp="Type:"; break;
  case "- Mot de Passe (si Privé) - Le nom du fichier de formulaire (si Texte étendu) => lib/sform/forum - Les Groupes ID (si Groupe)": $tmp="- Password (if Private) - Form file name (if Extended Text) in lib/sform/forum - Groups ID (if Group)"; break;
