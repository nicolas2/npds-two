...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext, $id) 
{
   ...
   if (file_exists("themes/".$theme."/views/index-news.html")) {$inclusion="themes/".$theme."/views/index-news.html";}
   elseif (file_exists("themes/default/views/index-news.html")) {$inclusion="themes/default/views/index-news.html";}
   else {
   ...
   if (!$imgtmp=theme::theme_image('topics/'.$topicimage)) {$imgtmp=$tipath.$topicimage;}
...
function themearticle ($aid, $informant, $time, $title, $thetext, $topic, $topicname, $topicimage, $topictext, $id, $previous_sid, $next_sid, $archive) 
{
   ...
   if (file_exists("themes/".$theme."/views/detail-news.html")) {$inclusion="themes/".$theme."/views/detail-news.html";}
   elseif (file_exists("themes/default/views/detail-news.html")) {$inclusion="themes/default/views/detail-news.html";}
   else {
...
function themesidebox($title, $content) 
{
   ...
   if (file_exists("themes/".$theme."/views/bloc-right.html") and ($bloc_side=="RIGHT")) {$inclusion='themes/'.$theme.'/views/bloc-right.html';}
   
   if (file_exists("themes/".$theme."/views/bloc-left.html") and ($bloc_side=="LEFT")) {$inclusion='themes/'.$theme.'/views/bloc-left.html';}
   
   if (!$inclusion) {
      if (file_exists("themes/".$theme."/views/bloc.html")) {$inclusion='themes/'.$theme.'/views/bloc.html';}
      elseif (file_exists("themes/default/views/footer.html")) {$inclusion='themes/default/views/bloc.html';}
      else {
...
function themedito($content) 
{
   ...
   if (file_exists("themes/".$theme."/views/editorial.html")) {$inclusion="themes/".$theme."/views/editorial.html";}
...
function userpopover($who,$dim) 
{
   ...
   if (stristr($temp_user['user_avatar'],'users_private')) 
      ...
      if ($ibid=theme::theme_image('forum/avatar/'.$temp_user['user_avatar'])) {$imgtmp=$ibid;} else {$imgtmp='assets/images/forum/avatar/'.$temp_user['user_avatar'];}
