...
function message_error($ibid,$op) 
{
    ...
    if (($o == 'only_newuser') or ($op == 'new user') or ($op == 'finish')) 
    {
        hidden_form();
 ...
 * @param  [type] $user_occ       [description]
 * @param  [type] $user_from      [description]
 * @param  [type] $user_intrest   [description]
 * @param  [type] $user_sig       [description]
 * @param  [type] $user_viewemail [description]
 * @param  [type] $pass           [description]
 * @param  [type] $vpass          [description]
 * @param  [type] $user_lnl       [description]
 * @param  [type] $C1             [description]
 * @param  [type] $C2             [description]
 * @param  [type] $C3             [description]
 * @param  [type] $C4             [description]
 * @param  [type] $C5             [description]
 * @param  [type] $C6             [description]
 * @param  [type] $C7             [description]
 * @param  [type] $C8             [description]
 ...
 * @param  [type] $setuid        [description]
 * @param  [type] $setuname      [description]
 * @param  [type] $setpass       [description]
 * @param  [type] $setstorynum   [description]
 * @param  [type] $setumode      [description]
 * @param  [type] $setuorder     [description]
 * @param  [type] $setthold      [description]
 * @param  [type] $setnoscore    [description]
 * @param  [type] $setublockon   [description]
 * @param  [type] $settheme      [description]
 * @param  [type] $setcommentmax [description]
 * @param  [type] $user_langue   [description]
 * @return [type]                [description]
 */
 ...
 * @param  [type] $usend_email    [description]
 * @param  [type] $uis_visible    [description]
 * @param  [type] $user_lnl       [description]
 * @param  [type] $C1             [description]
 * @param  [type] $C2             [description]
 * @param  [type] $C3             [description]
 ...
 * @param  [type] $raz_avatar     [description]
 * @return [type]                 [description]
 */
 ...
 * @param  [type] $ublockon [description]
 * @param  [type] $ublock   [description]
 * @return [type]           [description]
 */
