...
if (version_compare(PHP_VERSION, '5.3.0') >= 0 and extension_loaded('mysqli')) {
   ...
   fclose($fic);
   include_once('lib/database/mysqli.php');
} else
   include_once('lib/database/mysql.php');
...
function verif_chmod() {
   ...
   $file_to_check = array('storage/logs/abla.log.php','config/cache.config.php','config/config.php','config/filemanager.conf','storage/logs/security.log','config/meta.php','storage/static/edito.txt','modules/upload/upload.conf.php');
